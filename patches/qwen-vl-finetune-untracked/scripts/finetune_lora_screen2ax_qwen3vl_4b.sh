#!/bin/bash
# LoRA fine-tuning of Qwen3-VL-4B-Instruct on Screen2AX silver data.
#
...
# Hardware: 2x NVIDIA B200 (Blackwell) on GPUs 1,2. Requires PyTorch cu128.
...
OUTPUT_DIR=/workspace/trained_models/qwen3vl_4b_screen2ax_lora

deepspeed --include localhost:1,2 --master_port 29501 src/train/train_sft.py \
